...
import { T21Button, T21Card, T21Modal, Pictogram, Pictograms, useAudioGuide } from '../../../ui/components';
...
export const LiveSessionCard: React.FC<LiveSessionProps> = ({
  ...
  // Handle pause for rest (soft, no penalties)
  const handlePause = () => {
    setIsRunning(false);
    speak('Puedes descansar cuando lo necesites. No hay prisa.');
  };
